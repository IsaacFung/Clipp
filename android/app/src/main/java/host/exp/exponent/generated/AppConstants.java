...
public class AppConstants {
  ...
  public static String INITIAL_URL = "exp://exp.host/@isaacfung/my-app";
  public static final String SHELL_APP_SCHEME = "expc46f06de100e4120b96cff9ec99075b4";
  ...
  static {
    List<Constants.EmbeddedResponse> embeddedResponses = new ArrayList<>();
        ...
        embeddedResponses.add(new Constants.EmbeddedResponse("https://exp.host/@isaacfung/my-app", "assets://shell-app-manifest.json", "application/json"));
        embeddedResponses.add(new Constants.EmbeddedResponse("https://d1wp6m56sqw74a.cloudfront.net/%40isaacfung%2Fmy-app%2F1.0.3%2F9b53940abdce8017f71e597a1ff7a0a1-35.0.0-android.js", "assets://shell-app.bundle", "application/javascript"));
